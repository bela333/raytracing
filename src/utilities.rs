...
impl Vector3 {
    ...
    pub fn to_color_array(&self) -> [u8; 3] {
        ...
        [(x * 255f32) as u8, (y * 255f32) as u8, (z * 255f32) as u8]
    }
    ...
    pub fn pow(&self, a: f32) -> Self {
        Self::new(self.x.powf(a), self.y.powf(a), self.z.powf(a))
    }
    ...
    pub fn max(&self, a: Self) -> Self {
        Self::new(self.x.max(a.x), self.y.max(a.y), self.z.max(a.z))
    }

    pub fn min(&self, a: Self) -> Self {
        Self::new(self.x.min(a.x), self.y.min(a.y), self.z.min(a.z))
    }
...
impl Matrix3 {
    ...
    pub fn look_at_matrix(dir: Vector3) -> Self {
        let right = dir
            .cross(Vector3::new(0f32, 1f32, 0f32))
            .normalized()
            .multiply(-1f32);
